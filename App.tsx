    ...
    <div style={{display: 'flex', height: '100vh', backgroundColor: '#f8f9fa'}}>
      ...
      {!store.isAiChatOpen && (
          <button 
            ...
            style={{position: 'fixed', bottom: '1.5rem', right: '1.5rem', backgroundColor: '#004c59', color: 'white', borderRadius: '50%', padding: '1rem', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)', cursor: 'pointer', border: 'none', transition: 'transform 0.2s', transform: 'scale(1)'}}
